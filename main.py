...
def main():
    ...
    librarian = User("Librarian120", "librarian")
    ...
    librarian = User("manager", "manager")
    librarian.perform_inventory_actions(inventory, 'check_out', book=book1)
    librarian.perform_inventory_actions(inventory, 'return', book=book1)
